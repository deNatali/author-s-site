...
<section id="box3">
 <ul class="cssmenu">
			...
			<li>
				<a href="blog_atlas.html">Атласы</a>
			</li>
			<li>
				<a href="blog_scien.html">Научные статьи</a>
			</li>
			<li>
				<a href="blog_sc_popular.html">Научно-популярные работы</a>
			</li>
			<li>
				<a href="blog_biogr_memories.html">Биографические очерки и воспоминания</a>
			</li>
						...
						<?php 
						   ...
						   $query=("SELECT * FROM articles WHERE (tag = 'mon') ORDER BY id DESC");
